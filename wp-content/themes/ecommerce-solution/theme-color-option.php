<?php
	...
	$ecommerce_solution_custom_css .='.entry-date:hover i, .entry-date:hover a, .entry-author:hover i, .entry-author:hover a, .wp-block-button .wp-block-button__link:hover{';
		$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_first_color).' !important;';
	$ecommerce_solution_custom_css .='}';

	$ecommerce_solution_custom_css .='.page-content .read-moresec a.button, #slider .carousel-content, #scrollbutton i, .wp-block-button .wp-block-button__link:hover{';
			$ecommerce_solution_custom_css .='border-color: '.esc_attr($ecommerce_solution_first_color).';';
	$ecommerce_solution_custom_css .='}';

	$ecommerce_solution_custom_css .='.wp-block-woocommerce-empty-cart-block .wc-block-grid__product-onsale{';
			$ecommerce_solution_custom_css .='background-color: '.esc_attr($ecommerce_solution_first_color).'!important;';
	$ecommerce_solution_custom_css .='}';

	$ecommerce_solution_custom_css .='.wp-block-woocommerce-empty-cart-block .wc-block-grid__product-onsale{';
			$ecommerce_solution_custom_css .='border-color: '.esc_attr($ecommerce_solution_first_color).'!important;';
	$ecommerce_solution_custom_css .='}';
	...
	@media screen and (max-width:575px) {
		.copyright-wrapper{';
			$ecommerce_solution_custom_css .='text-align: center;'.esc_attr($ecommerce_solution_footer_text_align).'';
	$ecommerce_solution_custom_css .='} }';
	...
	if($ecommerce_solution_footer_bg_image != false){
		$ecommerce_solution_custom_css .='.footer-wp{';
			$ecommerce_solution_custom_css .='background: url('.esc_attr($ecommerce_solution_footer_bg_image).'); background-size: cover;';
		$ecommerce_solution_custom_css .='}';
	}

	// Footer Attatchment
	$ecommerce_solution_theme_lay = get_theme_mod( 'ecommerce_solution_footer_attatchment','scroll');
	if($ecommerce_solution_theme_lay == 'fixed'){
		$ecommerce_solution_custom_css .='.footer-wp{';
			$ecommerce_solution_custom_css .='background-attachment: fixed;';
		$ecommerce_solution_custom_css .='}';
	}elseif ($ecommerce_solution_theme_lay == 'scroll'){
		$ecommerce_solution_custom_css .='.footer-wp{';
			$ecommerce_solution_custom_css .='background-attachment: scroll;';
		$ecommerce_solution_custom_css .='}';
	}

	// footer heading font size
	$ecommerce_solution_footer_heading_font_size = get_theme_mod('ecommerce_solution_footer_heading_font_size');
	$ecommerce_solution_custom_css .='.footer-wp h3{';
		$ecommerce_solution_custom_css .='font-size: '.esc_attr($ecommerce_solution_footer_heading_font_size).'px;';
	$ecommerce_solution_custom_css .='}';

	$ecommerce_solution_theme_lay = get_theme_mod( 'ecommerce_solution_footer_text_tranform','Capitalize');
    if($ecommerce_solution_theme_lay == 'Uppercase'){
		$ecommerce_solution_custom_css .='.footer-wp h3{';
			$ecommerce_solution_custom_css .='text-transform: Uppercase;';
		$ecommerce_solution_custom_css .='}';
	...
	$ecommerce_solution_footer_heading_font_weight = get_theme_mod( 'ecommerce_solution_footer_heading_font_weight','500');
	if($ecommerce_solution_footer_heading_font_weight != ''){
		$ecommerce_solution_custom_css .='.footer-wp h3, .footer-wp .wp-block-heading{';
			$ecommerce_solution_custom_css .='font-weight: '.esc_attr($ecommerce_solution_footer_heading_font_weight).';';
		$ecommerce_solution_custom_css .='}';
	}

	// footer padding
	$ecommerce_solution_footer_padding = get_theme_mod('ecommerce_solution_footer_padding');
	$ecommerce_solution_custom_css .='.footer-wp{';
		$ecommerce_solution_custom_css .='padding: '.esc_attr($ecommerce_solution_footer_padding).'px !important;';
	$ecommerce_solution_custom_css .='}';
	...
	$ecommerce_solution_custom_css .='#scrollbutton i{';
		$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_scroll_icon_color).';';
	$ecommerce_solution_custom_css .='}';
	...
	$ecommerce_solution_custom_css .='#scrollbutton i:hover{';
		$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_scroll_icon_hover_color).';';
	$ecommerce_solution_custom_css .='}';

	//back to top bg color
	$ecommerce_solution_scroll_icon_background = get_theme_mod('ecommerce_solution_scroll_icon_background');
	$ecommerce_solution_custom_css .='#scrollbutton i{';
		$ecommerce_solution_custom_css .='background-color: '.esc_attr($ecommerce_solution_scroll_icon_background).';';
		$ecommerce_solution_custom_css .='border-color: '.esc_attr($ecommerce_solution_scroll_icon_background).';';
	$ecommerce_solution_custom_css .='}';

	//back to top bg hover color
	$ecommerce_solution_scroll_icon_bg_hover = get_theme_mod('ecommerce_solution_scroll_icon_bg_hover');
	$ecommerce_solution_custom_css .='#scrollbutton i:hover{';
		$ecommerce_solution_custom_css .='background-color: '.esc_attr($ecommerce_solution_scroll_icon_bg_hover).';';
		$ecommerce_solution_custom_css .='border-color: '.esc_attr($ecommerce_solution_scroll_icon_bg_hover).';';
	$ecommerce_solution_custom_css .='}';
	...
	//First Cap
	$ecommerce_solution_show_first_caps = get_theme_mod('ecommerce_solution_show_first_caps', 'false');
	if($ecommerce_solution_show_first_caps == 'true' ){
	$ecommerce_solution_custom_css .='.blog-section .mainbox .new-text p:nth-of-type(1)::first-letter{';
	$ecommerce_solution_custom_css .=' font-size: 55px; font-weight: 600;';
	$ecommerce_solution_custom_css .=' margin-right: 6px;';
	$ecommerce_solution_custom_css .=' line-height: 1;';
	$ecommerce_solution_custom_css .='}';
	}elseif($ecommerce_solution_show_first_caps == 'false' ){
	$ecommerce_solution_custom_css .='.blog-section .mainbox .new-text p:nth-of-type(1)::first-letter {';
	...
	$ecommerce_solution_btn_font_size_option = get_theme_mod('ecommerce_solution_btn_font_size_option');
	$ecommerce_solution_custom_css .='.postbtn a{';
		$ecommerce_solution_custom_css .='font-size: '.esc_attr($ecommerce_solution_btn_font_size_option).'px !important;';
	$ecommerce_solution_custom_css .='}';

	$ecommerce_solution_theme_lay = get_theme_mod( 'ecommerce_solution_tranform_button_text','Capitalize');
    if($ecommerce_solution_theme_lay == 'Uppercase'){
		$ecommerce_solution_custom_css .='.postbtn a{';
			$ecommerce_solution_custom_css .='text-transform: uppercase;';
		$ecommerce_solution_custom_css .='}';
	...
	// button font weight
	$ecommerce_solution_button_font_weight = get_theme_mod( 'ecommerce_solution_button_font_weight');
	if($ecommerce_solution_button_font_weight != ''){
		$ecommerce_solution_custom_css .='.postbtn a{';
			$ecommerce_solution_custom_css .='font-weight: '.esc_attr($ecommerce_solution_button_font_weight).';';
		$ecommerce_solution_custom_css .='}';
	}
	...
	$ecommerce_solution_preloader_bg_image = get_theme_mod('ecommerce_solution_preloader_bg_image');
	if($ecommerce_solution_preloader_bg_image != false){
		$ecommerce_solution_custom_css .='.frame{';
			$ecommerce_solution_custom_css .='background: url('.esc_attr($ecommerce_solution_preloader_bg_image).'); background-size: cover;';
		$ecommerce_solution_custom_css .='}';
	}
	...
	if($ecommerce_solution_woocommerce_product_border_enable == false){
		$ecommerce_solution_custom_css .='.products li{';
			$ecommerce_solution_custom_css .='border: none !important; box-shadow:none !important;';
		$ecommerce_solution_custom_css .='}';
	}
	...
	$ecommerce_solution_post_time = get_theme_mod( 'ecommerce_solution_display_post_time',true);
	if($ecommerce_solution_post_time == true && get_theme_mod( 'ecommerce_solution_metafields_time',true) != true){
	...
	$ecommerce_solution_slider = get_theme_mod( 'ecommerce_solution_display_slider',true);
	...
	$ecommerce_solution_custom_css .='.primary-navigation a, .topbar .primary-navigation a{';
		$ecommerce_solution_custom_css .='padding-top: '.esc_attr($ecommerce_solution_menu_top_bottom_padding).'px;';
		$ecommerce_solution_custom_css .='padding-bottom: '.esc_attr($ecommerce_solution_menu_top_bottom_padding).'px;';
	$ecommerce_solution_custom_css .='}';
	...
	$ecommerce_solution_custom_css .='.primary-navigation a, .topbar .primary-navigation a{';
		$ecommerce_solution_custom_css .='padding-left: '.esc_attr($ecommerce_solution_menu_left_right_padding).'px;';
		$ecommerce_solution_custom_css .='padding-right: '.esc_attr($ecommerce_solution_menu_left_right_padding).'px;';
	$ecommerce_solution_custom_css .='}';
	...
	// menu font weight
	$ecommerce_solution_font_weight_option_menu = get_theme_mod( 'ecommerce_solution_font_weight_option_menu','600');
	if($ecommerce_solution_font_weight_option_menu != ''){
		$ecommerce_solution_custom_css .='.primary-navigation a, .primary-navigation ul li a{';
			$ecommerce_solution_custom_css .='font-weight: '.esc_attr($ecommerce_solution_font_weight_option_menu).';';
		$ecommerce_solution_custom_css .='}';
	}
	...
	$ecommerce_solution_slider_heading_color = get_theme_mod('ecommerce_solution_slider_heading_color');
	$ecommerce_solution_custom_css .='#slider .inner_carousel h1{';
		$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_slider_heading_color).'!important;';
	$ecommerce_solution_custom_css .='}';

	//slider text color
	$ecommerce_solution_slider_text_color = get_theme_mod('ecommerce_solution_slider_text_color');
	$ecommerce_solution_custom_css .='#slider .inner_carousel p{';
		$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_slider_text_color).'!important;';
	$ecommerce_solution_custom_css .='}';

	//slider button text color
	$ecommerce_solution_slider_btn_text_color = get_theme_mod('ecommerce_solution_slider_btn_text_color');
	$ecommerce_solution_custom_css .='#slider .more-btn a{';
		$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_slider_btn_text_color).';';
	$ecommerce_solution_custom_css .='}';

	//slider button bg color
	$ecommerce_solution_slider_btn_bg_color = get_theme_mod('ecommerce_solution_slider_btn_bg_color');
	$ecommerce_solution_custom_css .='#slider .more-btn a{';
		$ecommerce_solution_custom_css .='background-color: '.esc_attr($ecommerce_solution_slider_btn_bg_color).';';
	$ecommerce_solution_custom_css .='}';
	...
	$ecommerce_solution_single_image_border_radius = get_theme_mod('ecommerce_solution_single_image_border_radius', 0);
	$ecommerce_solution_custom_css .='.feature-box img{';
		$ecommerce_solution_custom_css .='border-radius: '.esc_attr($ecommerce_solution_single_image_border_radius).'%;';
	$ecommerce_solution_custom_css .='}';

	$ecommerce_solution_single_image_box_shadow = get_theme_mod('ecommerce_solution_single_image_box_shadow',0);
	$ecommerce_solution_custom_css .='.feature-box img{';
		$ecommerce_solution_custom_css .='box-shadow: '.esc_attr($ecommerce_solution_single_image_box_shadow).'px '.esc_attr($ecommerce_solution_single_image_box_shadow).'px '.esc_attr($ecommerce_solution_single_image_box_shadow).'px #ddd;';
	$ecommerce_solution_custom_css .='}';

	// category color
	$ecommerce_solution_category_color = get_theme_mod('ecommerce_solution_category_color');
	$ecommerce_solution_custom_css .='.type-post .category ul li a{';
			$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_category_color).';';
	$ecommerce_solution_custom_css .='}';

	// category hover color
	$ecommerce_solution_category_hover_color = get_theme_mod('ecommerce_solution_category_hover_color');
	$ecommerce_solution_custom_css .='.type-post .category ul li a:hover{';
			$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_category_hover_color).';';
	$ecommerce_solution_custom_css .='}';
    ...
    if($ecommerce_solution_post_block_option == 'By Without Block'){
		$ecommerce_solution_custom_css .='.gridbox .inner-service, .related-inner-box, .mainbox-post, .layout2, .layout1, .post_format-post-format-video,.post_format-post-format-image,.post_format-post-format-audio, .post_format-post-format-gallery, .mainbox{';
	...
	// site logo padding 
	$ecommerce_solution_logo_padding_font_size = get_theme_mod('ecommerce_solution_logo_padding_font_size', '');
	$ecommerce_solution_custom_css .='.logo{';
	$ecommerce_solution_custom_css .='padding: '.esc_attr($ecommerce_solution_logo_padding_font_size).'px !important;';
	$ecommerce_solution_custom_css .='}';
	...
	// site title color
	$ecommerce_solution_site_title_color = get_theme_mod('ecommerce_solution_site_title_color');
	$ecommerce_solution_custom_css .='.logo a, .logo p a{';
		$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_site_title_color).'!important;';
	$ecommerce_solution_custom_css .='}';

	// site tagline color
	$ecommerce_solution_site_tagline_color = get_theme_mod('ecommerce_solution_site_tagline_color');
	$ecommerce_solution_custom_css .='.site-description{';
		$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_site_tagline_color).' !important;';
	$ecommerce_solution_custom_css .='}';

	// site toggle button color
	$ecommerce_solution_toggle_button_color = get_theme_mod('ecommerce_solution_toggle_button_color');
	$ecommerce_solution_custom_css .='.toggle-menu i{';
		$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_toggle_button_color).' !important;';
	$ecommerce_solution_custom_css .='}';

	//Copyright text color
	$ecommerce_solution_copyright_text_color = get_theme_mod('ecommerce_solution_copyright_text_color');
	$ecommerce_solution_custom_css .='.copyright-wrapper p, .copyright-wrapper p a{';
		$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_copyright_text_color).';';
	$ecommerce_solution_custom_css .='}';
	...
	$ecommerce_solution_custom_css .='.copyright-wrapper{';
		$ecommerce_solution_custom_css .='background-color: '.esc_attr($ecommerce_solution_copyright_text_background).';';
	$ecommerce_solution_custom_css .='}';

	// menu color
	$ecommerce_solution_menu_color = get_theme_mod('ecommerce_solution_menu_color');
	$ecommerce_solution_custom_css .='.primary-navigation a, .primary-navigation ul li a{';
			$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_menu_color).' !important;';
	$ecommerce_solution_custom_css .='}';

	// Sub menu color
	$ecommerce_solution_sub_menu_color = get_theme_mod('ecommerce_solution_sub_menu_color');
	$ecommerce_solution_custom_css .='.primary-navigation ul.children a, .primary-navigation ul.children li a, .primary-navigation ul.sub-menu a, .primary-navigation ul.sub-menu li a{';
			$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_sub_menu_color).' !important;';
	$ecommerce_solution_custom_css .='}';

	// menu hover color
	$ecommerce_solution_menu_hover_color = get_theme_mod('ecommerce_solution_menu_hover_color');
	$ecommerce_solution_custom_css .='.primary-navigation a:hover, .primary-navigation ul li a:hover{';
			$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_menu_hover_color).' !important;';
	$ecommerce_solution_custom_css .='}';

	// submenu hover color
	$ecommerce_solution_sub_menu_hover_color = get_theme_mod('ecommerce_solution_sub_menu_hover_color');
	$ecommerce_solution_custom_css .='.primary-navigation a:hover, .primary-navigation ul.children li a:hover, .primary-navigation ul.sub-menu li a:hover{';
			$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_sub_menu_hover_color).' !important;';
	$ecommerce_solution_custom_css .='}';

	// Sub menu bg color
	$ecommerce_solution_sub_menu_bg_color = get_theme_mod('ecommerce_solution_sub_menu_bg_color');
	$ecommerce_solution_custom_css .='.primary-navigation ul.children li a, .primary-navigation ul.sub-menu li a{';
			$ecommerce_solution_custom_css .='background-color: '.esc_attr($ecommerce_solution_sub_menu_bg_color).';';
	$ecommerce_solution_custom_css .='}';

	// Sub menu bg hover color
	$ecommerce_solution_sub_menu_bg_hover_color = get_theme_mod('ecommerce_solution_sub_menu_bg_hover_color');
	$ecommerce_solution_custom_css .='.primary-navigation ul.children li a:hover, .primary-navigation ul.sub-menu li a:hover{';
			$ecommerce_solution_custom_css .='background-color: '.esc_attr($ecommerce_solution_sub_menu_bg_hover_color).';';
	$ecommerce_solution_custom_css .='}';

	// site logo margin 
	$ecommerce_solution_logo_margin = get_theme_mod('ecommerce_solution_logo_margin', '');
	$ecommerce_solution_custom_css .='.logo{';
	$ecommerce_solution_custom_css .='margin: '.esc_attr($ecommerce_solution_logo_margin).'px ;';
	$ecommerce_solution_custom_css .='}';
