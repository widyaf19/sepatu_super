                ...
                <div class="row">
                  ...
                  <div class="<?php if( get_theme_mod( 'ecommerce_solution_site_logo_inline') != '') { ?>col-lg-7 col-md-7 col-7 site-logo-inline"<?php } else { ?>col-lg-12 col-md-12 <?php } ?>">
                    ...
                    if ( $description || is_customize_preview() ) : ?>
                      <?php if( get_theme_mod('ecommerce_solution_site_tagline_enable',false) != ''){ ?>
          ...
          <div class="row">          
            <div class="<?php if( get_theme_mod( 'ecommerce_solution_cart_enable_disable', true) != '') { ?> col-lg-10 col-md-9 align-self-center"<?php } else { ?>col-lg-12 col-md-12 <?php } ?>">
              <div class="toggle-menu responsive-menu text-start">
                <button role="tab" onclick="ecommerce_solution_menu_open()" class="mobiletoggle"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_responsive_menu_open_icon','fas fa-bars')); ?> p-3"></i><?php echo esc_html( get_theme_mod('ecommerce_solution_open_menu_label')); ?><span class="screen-reader-text"><?php esc_html_e('Open Menu','ecommerce-solution'); ?></span>
                </button>
              </div>
              <div id="navbar-header text-center" class="menu-brand primary-nav">
                ...
                <?php if(class_exists('woocommerce')){ ?>
                  ...
                  <?php } ?>
                <?php } ?>
                <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="ecommerce_solution_menu_close()"><?php echo esc_html( get_theme_mod('ecommerce_solution_close_menu_label')); ?><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_responsive_menu_close_icon','fas fa-times')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','ecommerce-solution'); ?></span></a>
              </div>
            </div>
